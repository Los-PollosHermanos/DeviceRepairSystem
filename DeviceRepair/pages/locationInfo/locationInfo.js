...
Page({
  ...
  loadOrders: function() {
    var that = this;
    wx.request({
      url: 'http://localhost:8080/WxServlet_war_exploded/location?requestType=loadLocation', 
      method: 'GET',
  ...
  searchOrders: function() {
    ...
    wx.request({
      url: 'http://localhost:8080/WxServlet_war_exploded/location?requestType=searchLocation&city=' + this.data.searchQuery,
      method: 'GET',
      success: function(res) {
        that.setData({
          order_list: res.data
  ...
  deleteOrder: function(e) {
    ...
    wx.showModal({
      ...
      success: function(res) {
        if (res.confirm) {
          wx.request({
            url: 'http://localhost:8080/WxServlet_war_exploded/location?requestType=deleteLocation&orderId=' + orderId,
            method: 'POST',
            success: function(res) {
